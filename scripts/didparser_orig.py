...
def main():
    #outfile=sys.argv[1]
    outfile="/media/param/DATA/code/python/lab/domain_mutations/dome2021/data/ppi/interaction/human_interfaces_3did_uniprotannotated.tsv"
    didfile="/media/param/DATA/code/python/lab/domain_mutations/dome2021/data/ppi/interaction/3did_flat.txt"
    unip="/media/param/DATA/code/python/lab/domain_mutations/dome2021/data/uniprot/uniprot_hs_proteome_12_4_2021.txt"
    ...
    p=PDBDbHandler("/media/param/DATA/code/python/lab/domain_mutations/dome2021/data/3d_structure/pdb_download/human/didpdb_matching/temptest")
